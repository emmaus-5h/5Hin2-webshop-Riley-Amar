...
insert into maintenance (design, explanation, temperature ) values ('Bar-top', 'The bartop design is as the name suggest on bar-tops, with its smaller design it is built to be a lot more durable. It is advised to make sure you avoid taking the bar-top to extreme temperatures', 0-30);
